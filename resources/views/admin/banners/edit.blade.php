                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('additional_text') is-invalid @enderror"
                                  id="additional_text" name="additional_text" rows="4">{{ old('additional_text', $banner->additional_text) }}</textarea>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="form-text">Leave empty to keep current image. Recommended size: 1920x600px. Max size: 2MB.</div>
                    </div>
