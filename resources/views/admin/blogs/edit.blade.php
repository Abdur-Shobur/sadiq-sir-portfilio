                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="editor-container" style="height: 400px;">
                            <div id="content" class="form-control @error('content') is-invalid @enderror" style="height: 350px;">{!! old('content', $blog->content) !!}</div>
                        </div>
                    ...
                    <div class="mb-3">
                        @if($blog->image)
                            <div class="mb-2">
                                ...
                                <img src="{{ Storage::url($blog->image) }}" alt="Current image" class="img-fluid rounded mt-2">
                            </div>
                        @endif
