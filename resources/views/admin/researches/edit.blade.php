            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="editor-container" style="height: 400px;">
                            <div id="long_description" class="form-control @error('long_description') is-invalid @enderror" style="height: 350px;">{!! old('long_description', $research->long_description) !!}</div>
                        </div>
                        <input type="hidden" name="long_description" id="long_description-input" value="{{ old('long_description', $research->long_description) }}">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <div class="form-text">Upload a new image (max 2MB)</div>
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        @if($research->image)
                            <div class="mb-2">
                                ...
                                <img src="{{ Storage::url($research->image) }}" alt="Current image" class="img-fluid rounded mt-2">
                            </div>
                        @endif
